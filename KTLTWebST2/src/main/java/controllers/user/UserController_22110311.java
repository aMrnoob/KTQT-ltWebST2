...
@WebServlet(urlPatterns = {"/user/book-of-author"})
public class UserController_22110311 extends HttpServlet{
	...
	protected void doGet (HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/views/user/bookOfAuthor.jsp").forward(request, response);	 
	}
